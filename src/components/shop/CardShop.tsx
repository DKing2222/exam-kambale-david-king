...
// import img2 from "../../assets/produits/img2.jpg";
//
import img1 from "../../assets/produits/img1.jpg";
import img2 from "../../assets/produits/img2.jpg";
import img3 from "../../assets/produits/img3.jpg";
import img4 from "../../assets/produits/img4.jpg";
//
  ...
  return (
    <Card className='mainCardShop'>
      <CardMedia
        ...
        image={index < imgs.length ? imgs[index] : img3}
        title='Article'
