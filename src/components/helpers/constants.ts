...
export const imgProjects = {
  projectOne:
    "https://res.cloudinary.com/chanel-david/image/upload/v1645354446/JoinAfriqueLogo_dhzddy.png",
  projectJoinAdmin:
    "https://res.cloudinary.com/chanel-david/image/upload/v1641466655/receptionAgent_cppcvd.png"
};
